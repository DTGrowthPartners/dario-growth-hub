          ...
          <div className="section-container">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {[
                ...
                <Card
                  key={plan.name}
                  className={`card-hover bg-card border-border/50 relative hover:border-t-4 hover:border-t-primary transition-all duration-300 ${
                      ...
                      <CarouselItem key={testimonial.name} className="pl-4 basis-full md:basis-1/2 lg:basis-1/3">
                        <Card className="bg-background/50 border-border/50 backdrop-blur-sm h-full">
                          <CardContent className="p-6 space-y-4 h-full flex flex-col">
                            ...
                            <blockquote className="text-muted-foreground italic flex-grow max-h-32 overflow-y-auto">
                              "{testimonial.review}"
                            </blockquote>
